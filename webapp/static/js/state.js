...
const brandAuthButton = document.getElementById('brand-auth-btn');
const brandAuthIcon = document.getElementById('brand-auth-icon');
const brandAuthRing = document.getElementById('brand-auth-ring');
...
const authAppDeviceList = document.getElementById('auth-app-device-list');
